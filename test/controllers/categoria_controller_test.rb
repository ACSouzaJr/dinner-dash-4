...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { cadastrado: @categorium.cadastrado, nome: @categorium.nome, numero: @categorium.numero } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { cadastrado: @categorium.cadastrado, nome: @categorium.nome, numero: @categorium.numero } }
